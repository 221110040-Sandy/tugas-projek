...
class _CustomerScreenState extends State<CustomerScreen> {
  ...
  List<QueryDocumentSnapshot> customers =
      []; // Untuk menyimpan daftar pelanggan
  List<QueryDocumentSnapshot> filteredCustomers =
      []; // Untuk daftar yang difilter

  @override
  void initState() {
    super.initState();
    // Ambil data pelanggan pertama kali
    firestoreService.customersCollection.snapshots().listen((snapshot) {
      setState(() {
        customers = snapshot.docs;
        filteredCustomers =
            customers; // Awalnya, daftar yang difilter sama dengan daftar asli
      });
    });
  }
